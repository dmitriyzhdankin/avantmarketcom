...
//                    $productSKU = $productSKUs->getById($product['sku_id']);
//                    $productSTOCKs = new shopProductStocksModel();
//                    $productSTOCK = $productSTOCKs->getBySkuId($product['sku_id']);
//                    $product['sku'] = $productSKU;
//                    $product['stock'] = $productSTOCK ? $productSTOCK[$product['sku_id']] : '';
//                    
//                    $view = wa()->getView();
//                    $view->assign('products', array($product));
//                    $theme = new waTheme(waRequest::getTheme());
//
//                    $html .= $view->fetch($theme->path . '/list-thumbs.html');
                    $wa = new shopViewHelper(waSystem::getInstance());
                    $product = $wa->product($item['url']);
                    $html .= '<li>
