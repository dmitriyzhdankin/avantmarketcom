    ...
    $.shop = {
        ...
        helper: {
            ...
            print: function(el) {
                ...
                var html = '<html><head>' + $head.html() + '<style type="text/css" media="print">* {overflow:visible !important; }</style></head><body class="s-printable">' + $body.html()
                + '<i class="icon16 loading" style="top: 20px; left: 20px; position: relative;display: none;"></i>' + '</body></html>';
          
                var wnd = window.open('', '_blank', 'menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes');
                setTimeout(function() {
                    var $w = $(wnd.document);
